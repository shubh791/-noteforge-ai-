...
④ DEFINITIONS AND EXPLANATIONS — always render as numbered list, NEVER as a "Def:" box. When the input gives a definition or explanation, write it as numbered points:
<ol style="list-style:none;margin:8px 0 11px;padding:0">
  <li style="font-family:'Outfit',sans-serif;font-size:13px;color:#374151;padding:6px 0 6px 16px;margin:0 0 5px 10px;border-left:3px solid #c4b5fd;background:linear-gradient(135deg,#faf5ff,#ffffff);border-radius:0 6px 6px 0;line-height:1.75"><span style="font-weight:800;color:#7c3aed;margin-right:6px">1.</span>First point or definition here</li>
  <li style="font-family:'Outfit',sans-serif;font-size:13px;color:#374151;padding:6px 0 6px 16px;margin:0 0 5px 10px;border-left:3px solid #c4b5fd;background:linear-gradient(135deg,#faf5ff,#ffffff);border-radius:0 6px 6px 0;line-height:1.75"><span style="font-weight:800;color:#7c3aed;margin-right:6px">2.</span>Second point here</li>
</ol>
NEVER use "Def:" label anywhere in the output.
...
6.  NEVER use "Def:" anywhere. All definitions and explanations must be numbered list items ④.
7.  Whenever the input has a * before text or marks something important, use the Key Point callout ⑦. Strip the * and put the text inside the callout.
